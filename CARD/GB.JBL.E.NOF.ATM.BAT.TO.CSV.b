* @ValidationCode : MjotMTIyNTA0Mjc5NjpDcDEyNTI6MTcwNDcxMDk5NDUxMTpuYXppaGFyOi0xOi0xOjA6MDpmYWxzZTpOL0E6REVWXzIwMTcxMC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 08 Jan 2024 16:49:54
...
*-----------------------------------------------------------------------------
    ...
    Y.REQUEST.TYPE = R.BATCH<EB.CARD.BAT.REQUEST.TYPE>
    ...
    FOR I=1 TO Y.COUNT
        ...
        IF Y.CARD.STATUS EQ "PENDING" AND Y.REQUEST.TYPE EQ Y.REQUEST.TYPE THEN
            Y.RETURN<-1>= Y.RESULT
        END
    NEXT I
