* @ValidationCode : MjoyNjQwNTU0ODI6Q3AxMjUyOjE3MDQyNjE0MDAzMzg6bmF6aWhhcjotMTotMTowOjA6ZmFsc2U6Ti9BOkRFVl8yMDE3MTAuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 03 Jan 2024 11:56:40
...
* ETEXT ="CARD NUMBER ALREADY USED ANOTHER ACCOUNT"
                EB.SystemTables.setEtext("CARD NUMBER ALREADY USED ANOTHER ACCOUNT")
                EB.ErrorProcessing.StoreEndError()
                Y.CHECK = 1
                BREAK
            END
