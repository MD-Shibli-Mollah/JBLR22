...
* EB.LocalReferences.GetLocRef(Appl, Fieldname, Pos)
    ...
    EB.LocalReferences.GetLocRef('CUSTOMER','LT.CUS.COMU.VILL',Y.COMU.VILL)
    ...
    EB.LocalReferences.GetLocRef('CUSTOMER','LT.CUS.COMU.DIST',Y.COMU.DIST)
    EB.LocalReferences.GetLocRef('CUSTOMER','LT.CUS.COMU.PCODE',Y.COMU.PCODE)
    EB.LocalReferences.GetLocRef('CUSTOMER','LT.CUS.COMU.CONT',Y.COMU.CONT)
